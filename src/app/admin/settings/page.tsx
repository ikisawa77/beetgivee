...
type TextSettingKey = Exclude<keyof SiteSettings, "loaderEnabled" | "loaderDuration">;
const fields: Array<{ key: TextSettingKey; label: string; placeholder?: string; long?: boolean }> = [
